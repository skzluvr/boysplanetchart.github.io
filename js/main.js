...
// Get data
d3.csv("boysplanet.csv", parseLine, function (err, data) {
...
function getRankInfo(d) {
    ...
    return "Current Contestant, Rank " + d.currentRank + " " + displayRankChange(d);
}
